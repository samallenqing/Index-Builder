...
public class MySQLAccess {
    ...
    public void getConnection() throws Exception {
        try {
            ...
            String conn = "jdbc:mysql://" + d_server_name + "/" + "?user=" + d_user_name + "&password=" + d_password;
            Connection connection = DriverManager.getConnection(conn);
            String createDataBase = "CREATE DATABASE " + d_db_name;
            Statement statement = connection.createStatement();
            statement.execute(createDataBase);
            System.out.println("Database AmazonAd Created!");
        }
    }
    ...
    private Boolean isRecordExist(String sql_string) throws SQLException {
        ...
        try {
            ...
            System.out.println(e.getMessage());
            String createTable = "CREATE TABLE ad (" +
                    "adId int(11), campaignId int(11), " +
